            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="flex flex-col items-center text-center p-6 rounded-xl bg-gradient-to-br from-red-50 to-white border border-red-100 card-hover">
                        ...
                        <div className="font-bold text-2xl mb-1" style={{ color: 'var(--brand-red)' }}>200+</div>
                    ...
                    {/* Badge 3 - Highlighted */}
                    <div className="flex flex-col items-center text-center p-8 rounded-xl bg-gradient-to-br from-purple-100 to-white border-2 border-purple-300 card-hover shadow-lg">
                        <div className="w-20 h-20 rounded-full bg-purple-600 flex items-center justify-center mb-4">
                            <TrendingUp className="w-10 h-10 text-white" />
                        </div>
                        <div className="font-extrabold text-4xl text-purple-600 mb-2">30%</div>
                        <div className="text-base font-bold text-purple-700">Cost Saving</div>
                        <div className="text-sm text-gray-600 mt-1">Compared to Air Freight</div>
                    </div>
                </div>
            </div>
        </section>
